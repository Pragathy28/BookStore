...
public class PlaceOrder extends JFrame {
 ...
 public PlaceOrder() {
  ...
  heading = new JLabel("Please Find List of All Books offered by us");
  heading.setFont(new Font(Font.SANS_SERIF, Font.ITALIC, 30));
  heading.setBounds(300, 50, 640, 50);

  fooditems = new JLabel("BOOKS");
  fooditems.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 20));
  fooditems.setBounds(300, 100, 300, 50);

  item1 = new JLabel("1. Harry Potter.....................Rs.500");
  item2 = new JLabel("2. Poor dad and rich dad....................Rs.399");
  item3 = new JLabel("3. Think like a monk....................Rs.349");
  ...
  cb_item1.addItemListener(new ItemListener() {
   ...
   public void itemStateChanged(ItemEvent e) {
    ...
    if (e.getStateChange() == 1) {
     String result = "Harry Potter - Rs 500.";
     amount += 500.00;
